...
public class Voting extends ListenerAdapter {
    ...
    public static String alias = "survey";
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        ...
        if (args[0].equalsIgnoreCase(c.prefix + "voting") || args[0].equalsIgnoreCase(c.prefix + alias)) {
            ...
            try {
                ...
                if (args.length < 2) {
                    ...
                    em.setTitle("VOTING");
                    em.setDescription(done.toString().replace(";", "\n"));
