...
public class Calling extends ListenerAdapter {

    public static String alias = "call";
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        ...
        if (args[0].equalsIgnoreCase(c.prefix + "calling") || args[0].equalsIgnoreCase(c.prefix + alias)) {
            ...
            if (args.length < 2) {
                ...
                em.setImage("https://api.alexflipnote.dev/calling?text=" + done);
