...
public class Captcha extends ListenerAdapter {
...
public static String alias = "There's no aliases.";
	...
	public void onGuildMessageReceived(GuildMessageReceivedEvent Context) {
		...
		if (messageSent[0].equalsIgnoreCase(c.prefix + "captcha")) {
			...
			if (messageSent.length < 2) {
				...
				em.setImage("https://api.alexflipnote.dev/captcha?text=" + done);
