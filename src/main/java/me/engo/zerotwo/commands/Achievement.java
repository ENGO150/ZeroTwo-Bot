...
public class Achievement extends ListenerAdapter {
	...
	public void onGuildMessageReceived(GuildMessageReceivedEvent Context) {
		...
		if (messageSent[0].equalsIgnoreCase(c.prefix + "achievement")) {
			String language;
			...
			if (messageSent.length < 2) {
				...
				em.setImage("https://api.alexflipnote.dev/achievement?text=" + done);
